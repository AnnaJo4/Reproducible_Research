...
**The average daily pattern shows the highest value for the number of steps in the 5-min interval: `r maxint`, which corresponds to `r maxtime` o'clock, when the number of steps is `r maxsteps`.**
...
**The number of rows with missing values is `r missingvalues`, which is `r missingperc` %.**
...
**The mean of the total number of steps taken per day of the original dataset is `r stepsmean`, and the median is `r stepsmedian`.**
**The recalculated mean of the total number of steps taken per day with imputing missing values is `r stepsmean_nona`, and the median is `r stepsmedian_nona`.**
